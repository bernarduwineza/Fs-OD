...
The main intuitive assumption is that $\mathcal{F}$ is able to transfer the features learned from base classes to 
...
\textbf{Euclidean distance-based Similarity. }
...
Recent works (such as \cite{chen2019closer,qi2018low,gidaris2018dynamic}) have proposed 
box classifiers based on cosine similarity. 
